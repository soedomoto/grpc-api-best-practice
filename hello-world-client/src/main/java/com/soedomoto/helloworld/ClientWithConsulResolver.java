...
import io.grpc.resolver.atomix.AtomixNameResolverFactory;
import io.grpc.resolver.consul.ConsulNameResolverProvider;
...
public class ClientWithConsulResolver {
    private static Logger logger = LoggerFactory.getLogger(ClientWithConsulResolver.class.getName());

    public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
        ManagedChannel channel = ManagedChannelBuilder
                .forTarget(String.format("consul://%s:%d/%s", "localhost", 8500, "service-greet"))
