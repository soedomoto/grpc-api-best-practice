...
public class ClientWithAtomixResolver {
    private static Logger logger = LoggerFactory.getLogger(ClientWithAtomixResolver.class.getName());

    public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
        ManagedChannel channel = ManagedChannelBuilder
                .forTarget(String.format("atomix://%s:%d/%s", "localhost", 8701, "service-greet"))
